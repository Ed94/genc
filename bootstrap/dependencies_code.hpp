using namespace gen;
// This is a temporary file until I setup a scanner for files.

StrC str_clang_pragmas = txt_StrC(
R"(#if __clang__
...
StrC str_platform_detection = txt_StrC(
R"(#pragma region Platform Detection
...
StrC str_mandatory_includes = txt_StrC(
R"(#pragma region Mandatory Includes
#	include <stdarg.h>
#	include <stddef.h>
