...
global gen_u32 const gen__crc32_table[ 256 ] = {
...
global gen_u64 const gen__crc64_table[ 256 ] = {
...
{
	gen_sw        remaining;
	gen_u32       result = ~( zpl_cast( gen_u32 ) 0 );
	gen_u8 const* c      = zpl_cast( gen_u8 const* ) data;
...
{
	gen_sw        remaining;
	gen_u64       result = ( zpl_cast( gen_u64 ) 0 );
	gen_u8 const* c      = zpl_cast( gen_u8 const* ) data;
	for ( remaining = len; remaining--; c++ )
