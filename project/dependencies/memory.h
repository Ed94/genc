...
typedef enum gen_AllocType
{
	gen_EAllocation_ALLOC,
	gen_EAllocation_FREE,
	gen_EAllocation_FREE_ALL,
	gen_EAllocation_RESIZE,
} gen_AllocType;
...
typedef GEN_ALLOCATOR_PROC( gen_AllocatorProc );

typedef struct gen_AllocatorInfo
{
...
GEN_DEF_INLINE void* gen_alloc_align( gen_AllocatorInfo a, gen_sw size, gen_sw alignment );

//! Allocate memory with default alignment.
GEN_DEF_INLINE void* gen_alloc( gen_AllocatorInfo a, gen_sw size );

//! Free allocated memory.
GEN_DEF_INLINE void gen_free( gen_AllocatorInfo a, void* ptr );

//! Free all memory allocated by an allocator.
GEN_DEF_INLINE void gen_free_all( gen_AllocatorInfo a );

//! Resize an allocated memory.
GEN_DEF_INLINE void* gen_resize( gen_AllocatorInfo a, void* ptr, gen_sw old_size, gen_sw new_size );

//! Resize an allocated memory with specified alignment.
GEN_DEF_INLINE void* gen_resize_align( gen_AllocatorInfo a, void* ptr, gen_sw old_size, gen_sw new_size, gen_sw alignment );

//! Allocate memory and copy data into it.
GEN_DEF_INLINE void* gen_alloc_copy( gen_AllocatorInfo a, void const* src, gen_sw size );

//! Allocate memory with specified alignment and copy data into it.
GEN_DEF_INLINE void* gen_alloc_copy_align( gen_AllocatorInfo a, void const* src, gen_sw size, gen_sw alignment );

//! Allocate memory for null-terminated C-String.
char* gen_alloc_str( gen_AllocatorInfo a, char const* str );

//! Allocate memory for C-String with specified size.
GEN_DEF_INLINE char* gen_alloc_str_len( gen_AllocatorInfo a, char const* str, gen_sw len );

#ifndef gen_alloc_item

//! Allocate memory for an item.
#	define gen_alloc_item( allocator_, Type ) ( Type* ) gen_alloc( allocator_, size_of( Type ) )

//! Allocate memory for an array of items.
#	define gen_alloc_array( allocator_, Type, count ) ( Type* ) gen_alloc( allocator_, size_of( Type ) * ( count ) )
#endif
...
GEN_DEF_INLINE void* gen_default_resize_align( gen_AllocatorInfo a, void* ptr, gen_sw old_size, gen_sw new_size, gen_sw alignment );

//! The heap allocator backed by operating system's memory manager.
GEN_DEF_INLINE gen_AllocatorInfo gen_heap_allocator( void );
                          GEN_ALLOCATOR_PROC( gen_heap_allocator_proc );

#ifndef gen_malloc

//! Helper to allocate memory using heap allocator.
#	define gen_malloc( sz ) gen_alloc( gen_heap_allocator(), sz )

//! Helper to free memory allocated by heap allocator.
#	define gen_mfree( ptr ) gen_free( gen_heap_allocator(), ptr )

//! Alias to heap allocator.
#	define gen_heap gen_heap_allocator
#endif
...
GEN_DEF_INLINE void gen_arena_init_from_allocator( gen_Arena* arena, gen_AllocatorInfo backing, gen_sw size );
...
GEN_DEF_INLINE gen_AllocatorInfo gen_arena_allocator( gen_Arena* arena );
                          GEN_ALLOCATOR_PROC( gen_arena_allocator_proc );

typedef struct gen_ArenaSnapshot
{
	gen_Arena* arena;
...
GEN_DEF_INLINE gen_ArenaSnapshot gen_arena_snapshot_begin( gen_Arena* arena );

//! Reset memory arena's usage by a captured snapshot.
GEN_DEF_INLINE void gen_arena_snapshot_end( gen_ArenaSnapshot tmp_mem );
...
GEN_DEF_INLINE void gen_pool_init( gen_Pool* pool, gen_AllocatorInfo backing, gen_sw num_blocks, gen_sw block_size );
...
GEN_DEF_INLINE gen_AllocatorInfo gen_pool_allocator( gen_Pool* pool );
                          GEN_ALLOCATOR_PROC( gen_pool_allocator_proc );

/* inlines */

GEN_IMPL_INLINE void* gen_alloc_align( gen_AllocatorInfo a, gen_sw size, gen_sw alignment )
{
	return a.proc( a.data, gen_EAllocation_ALLOC, size, alignment, NULL, 0, GEN_DEFAULT_ALLOCATOR_FLAGS );
}

GEN_IMPL_INLINE void* gen_alloc( gen_AllocatorInfo a, gen_sw size )
{
	return gen_alloc_align( a, size, GEN_DEFAULT_MEMORY_ALIGNMENT );
}

GEN_IMPL_INLINE void gen_free( gen_AllocatorInfo a, void* ptr )
{
	if ( ptr != NULL )
		a.proc( a.data, gen_EAllocation_FREE, 0, 0, ptr, 0, GEN_DEFAULT_ALLOCATOR_FLAGS );
}

GEN_IMPL_INLINE void gen_free_all( gen_AllocatorInfo a )
{
	a.proc( a.data, gen_EAllocation_FREE_ALL, 0, 0, NULL, 0, GEN_DEFAULT_ALLOCATOR_FLAGS );
}

GEN_IMPL_INLINE void* gen_resize( gen_AllocatorInfo a, void* ptr, gen_sw old_size, gen_sw new_size )
{
	return gen_resize_align( a, ptr, old_size, new_size, GEN_DEFAULT_MEMORY_ALIGNMENT );
}

GEN_IMPL_INLINE void* gen_resize_align( gen_AllocatorInfo a, void* ptr, gen_sw old_size, gen_sw new_size, gen_sw alignment )
{
	return a.proc( a.data, gen_EAllocation_RESIZE, new_size, alignment, ptr, old_size, GEN_DEFAULT_ALLOCATOR_FLAGS );
}

GEN_IMPL_INLINE void* gen_alloc_copy( gen_AllocatorInfo a, void const* src, gen_sw size )
{
	return gen_mem_copy( gen_alloc( a, size ), src, size );
}

GEN_IMPL_INLINE void* gen_alloc_copy_align( gen_AllocatorInfo a, void const* src, gen_sw size, gen_sw alignment )
{
	return gen_mem_copy( gen_alloc_align( a, size, alignment ), src, size );
}

GEN_IMPL_INLINE char* gen_alloc_str_len( gen_AllocatorInfo a, char const* str, gen_sw len )
{
	char* result;
...
GEN_IMPL_INLINE void* gen_default_resize_align( gen_AllocatorInfo a, void* old_memory, gen_sw old_size, gen_sw new_size, gen_sw alignment )
{
	if ( ! old_memory )
...
GEN_IMPL_INLINE gen_AllocatorInfo gen_heap_allocator( void )
{
	gen_AllocatorInfo a;
...
GEN_IMPL_INLINE void gen_arena_init_from_allocator( gen_Arena* arena, gen_AllocatorInfo backing, gen_sw size )
{
...
GEN_IMPL_INLINE void gen_arena_check( gen_Arena* arena )
{
	GEN_ASSERT( arena->temp_count == 0 );
}

GEN_IMPL_INLINE gen_AllocatorInfo gen_arena_allocator( gen_Arena* arena )
{
...
GEN_IMPL_INLINE gen_ArenaSnapshot gen_arena_snapshot_begin( gen_Arena* arena )
{
	gen_ArenaSnapshot tmp;
	tmp.arena          = arena;
...
GEN_IMPL_INLINE void gen_arena_snapshot_end( gen_ArenaSnapshot tmp )
{
...
GEN_IMPL_INLINE void gen_pool_init( gen_Pool* pool, gen_AllocatorInfo backing, gen_sw num_blocks, gen_sw block_size )
{
...
GEN_IMPL_INLINE void gen_pool_free( gen_Pool* pool )
{
	...
	{
		gen_free( pool->backing, pool->physical_start );
	}
}

GEN_IMPL_INLINE gen_AllocatorInfo gen_pool_allocator( gen_Pool* pool )
{
	gen_AllocatorInfo allocator;
